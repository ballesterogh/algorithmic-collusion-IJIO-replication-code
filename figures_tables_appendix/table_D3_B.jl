########################################
## TABLE D.3: Action set - robustness ##
########################################
...
@load joinpath(data_dir, "outcomes_stochastic_action_48.jld2") game Q_matrix profits actions cost t_final bf;
...
writedlm("table_D3_B.txt", output_lines)
