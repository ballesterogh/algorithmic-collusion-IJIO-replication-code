...
for c=1:game.dim_C
    for r=1:game.dim_rho
        ...
        scatter!(collect(2:2:T), price_serie_mean[2,2:2:T,c,r],ylim=(-.3,.3),label="",yticks=(round.(collect(-3/game.k : 1/game.k : 3/game.k), digits=2)),markersize=5) #deviating agent
