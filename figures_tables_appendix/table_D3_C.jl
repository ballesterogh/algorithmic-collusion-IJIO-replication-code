########################################
## TABLE D.3 -- Panel C: Action set - robustness ##
########################################
...
@load joinpath(data_dir, "outcomes_stochastic_action_108.jld2") game Q_matrix profits actions cost t_final bf;
...
writedlm("table_D3_C.txt", output_lines)
