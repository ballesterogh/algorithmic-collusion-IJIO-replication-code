...
# load packages
using Pkg
required_packages = ["Plots", "StatsPlots", "Statistics", "DelimitedFiles", "Serialization","JLD2","Revise","Measures","Random","NaNStatistics"]
...
table, price_serie_mean, p_serie_mean, p_diff = price_deviation_analysis(game, bf, T, "price_hike")
